  ...
  return (
    <section className="mx-8">
      <BlurFade delay={BLUR_FADE_DELAY}>
        ...
        <p className="mb-8">
          I love exploring technical topics and turning them into
          easy-to-understand blogs. Here, you will find some of my favorite
          pieces, written to share knowledge and help others learn. Feel free to
          check them out!
        </p>
      </BlurFade>
      ...
      <BlurFade delay={BLUR_FADE_DELAY * 2 + posts.length * 0.05}>
        <p className="text-center my-8 text-sm text-muted-foreground">
          ...
          <Link
            ...
            href="https://hashnode.com/@YashkShrivas4491"
          >
            hashnode
          </Link>{" "}
          for more content!
